                ...
                <MessageContent
                  className={
                    message.role === "assistant"
                      ? "text-[#2b1f3a]/90 font-sans font-light tracking-wide leading-relaxed"
                      : "text-[#2b1f3a] bg-[#6a5acd]/5 hover:bg-[#6a5acd]/10 border border-[#6a5acd]/10 font-sans font-light tracking-wide leading-relaxed shadow-[0_0_15px_rgba(106,90,205,0.05)]"
                  }
                />
                <ToolcallInfo />
